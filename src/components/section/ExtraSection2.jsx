  ...
  return (
    <section className='bg-white py-10 md:py-16 lg:py-[80px] flex flex-col space-y-10'>
      <div className='px-5 md:px-20'>
        <div className='bg-[#faf7f7] space-y-2 h-full flex flex-col justify-center items-center py-10 md:py-16'>
          <h2 className='font-raleway text-4xl text-center md:text-left font-semibold'>
