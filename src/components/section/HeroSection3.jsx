...
function HeroSection3() {
  return (
    <section className='relative min-h-screen flex flex-col md:flex-row justify-center items-center px-5 md:px-0 bg-[#ffffff] gap-8 bg-[url(kitchen-white.png)] bg-no-repeat bg-left md:bg-none'>
      <div className='w-full md:w-[50%] h-screen md:pl-12 lg:pl-20 pt-20 relative z-10 flex flex-col justify-around'>
        <div className='space-y-4'>
          ...
          <div className='space-y-2 text-center md:text-left'>
            ...
            <p className='font-semibold text-gray-600 md:w-[80%]'>
          ...
          <div className='mt-4 space-y-4 font-semibold'>
            ...
            <div className='flex gap-2 md:gap-4 justify-center md:justify-start flex-wrap'>
              <a href='/contact' className='flex gap-2 items-center text-[#fafafa] bg-primary px-10 py-4 md:text-sm rounded-sm'>
                Get Free Quote
                <ArrowRight size={16} />
              </a>
        ...
        <div>
          <div className='flex flex-col md:flex-row gap-2 md:gap-4 justify-center md:justify-start items-center'>
            <div className='flex gap-2 items-center bg-white/10 px-3 py-2 rounded-full font-semibold text-gray-600'>
